...
function showHideGallery() {
    $( "#panorama" ).toggleClass( "d-none" );
    $( "#san-valentin-carouselControls" ).toggleClass( "d-none" );
    $( "#tour-button" ).toggleClass( "d-none" );
    $( "#gallery-button" ).toggleClass( "d-none" );
}
...
$(document).ready(function() {
	$("h1:not(.no-wow)").addClass('wow fadeInUp');
	$("h2:not(.no-wow)").addClass('wow fadeInUp');
	$("h3:not(.no-wow)").addClass('wow fadeInUp');
	$("h4:not(.no-wow)").addClass('wow fadeInUp');
